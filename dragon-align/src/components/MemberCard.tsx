...
import { Edit3, Plus, GripVertical } from 'lucide-react';
...
interface MemberCardProps {
  ...
  className?: string;
  source?: string;
  onDragStart?: (e: React.DragEvent, member: TeamMember, source: string) => void;
  onDragEnd?: () => void;
}
...
const MemberCard: React.FC<MemberCardProps> = ({
  ...
  <div 
    ...
    draggable={draggable}
    onDragStart={draggable && onDragStart ? (e) => onDragStart(e, member, source) : undefined}
    onDragEnd={onDragEnd}
  >
          ...
          <div className="flex items-center gap-1">
            ...
            <div>
              ...
              <div className="text-xs text-gray-600 space-y-1">
                ...
                <div>Roles: {member.roles.join(', ')}</div>
